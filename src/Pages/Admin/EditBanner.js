...
const EditBanner = () => {
  ...
  const handleBanner = (event) => {
    ...
    const bannerTypingOne = event.target.bannerTypingOne.value;
    const bannerTypingTwo = event.target.bannerTypingTwo.value;
    const bannerTypingThree = event.target.bannerTypingThree.value;
      ...
      <form className="form mb-15 seo-form" onSubmit={handleBanner}>
        {banner.map((e) => (
          <div className="container" key={e._id}>
            ...
            {/* typing */}
            <div className="col-sm">
              <label className="mt-1">Enter Banner Typing One</label>
              <div className="form-group mb-3">
                <input
                  type="text"
                  className="form-control"
                  placeholder="Enter Banner Typing One"
                  name="bannerTypingOne"
                  defaultValue={e.bannerTypingOne}
                />
              </div>
            </div>
            <div className="col-sm">
              <label className="mt-1">Enter Banner Typing Two</label>
              <div className="form-group mb-3">
                <input
                  type="text"
                  className="form-control"
                  placeholder="Enter Banner Typing Two"
                  name="bannerTypingTwo"
                  defaultValue={e.bannerTypingTwo}
                />
              </div>
            </div>
            <div className="col-sm">
              <label className="mt-1">Enter Banner Typing Three</label>
              <div className="form-group mb-3">
                <input
                  type="text"
                  className="form-control"
                  placeholder="Enter Banner Typing Three"
                  name="bannerTypingThree"
                  defaultValue={e.bannerTypingThree}
                />
              </div>
            </div>
