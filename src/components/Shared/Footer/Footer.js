          ...
          <div className="row">
            ...
            <div className="col-md-3 col-lg-2 col-xl-2">
              <div className="footer-links mb-40">
                {/* Title */}
                <h5 className="h5-sm text-white">Quick Links</h5>
                {/* Footer Links */}
                <ul className="foo-links clearfix ">
                  <li className="nl-simple">
                    <Link to="/" aria-haspopup="true" className="text-white">
                      Home
                    </Link>
                  </li>
                  <li className="nl-simple">
            ...
            <div className="col-md-4 col-lg-3 col-xl-3">
              <div className="footer-links mb-40">
                {/* Title */}
                <h5 className="h5-sm text-white">Quick Connect</h5>
                {/* Footer Links */}
                {contact.map((e) => (
                  <ul className="clearfix">
                    <li>
                      <p>
                        <a href={`tel:${e.phone}`} className="text-white">
                          {e.phone}
                        </a>
                      </p>
                    </li>
                    <li>
                      <p className="last-li">
                        <a href={`mailto:${e.email}`} className="text-white">
                          {e.email}
                        </a>
                      </p>
                    </li>
                    <li>
                      <p className="last-li text-white">{e.address}</p>
                    </li>
                  </ul>
                ))}
              </div>
            ...
            <div className="col-md-5 col-lg-3 col-xl-3">
              <div className="footer-form mb-20">
                {/* Title */}
                <h5 className="h5-sm text-white">Follow the Best</h5>
