              ...
              <div className="col-xl-10 offset-xl-1">
                <div className="hero-txt text-center">
                  <h3 className="indigo-color">
                    {/* add here the typing effect */}

                    {banner.length > 0 ? (
                      <>
                        <h3 className="indigo-color">
                          {banner[0].bannerHeading}
                          {banner[0].bannerTypingOne &&
                            banner[0].bannerTypingTwo &&
                            banner[0].bannerTypingThree && (
                              <Typewriter
                                options={{
                                  strings: [
                                    banner[0].bannerTypingOne,
                      ...
                      <h3 className="indigo-color">Loading</h3>
                    )}
                  </h3>

                  <p className="indigo-color">
                    {banner.length > 0 ? banner[0].bannertext : "Loading"}
                  </p>
